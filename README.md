Desenvolvimento de testes unitários para validar uma API REST de gerenciamento de estoques de cerveja feita durante o Bootcamp da Digital Innovation One - DIO - GFT Start 2 - JAVA
